...
public class MoneyTest {
	...
	public void testGlobalValue() {
		...
		assertEquals(0.15, SEK100.getCurrency().getRate(), 0.001);
		assertEquals(1.5, EUR0.getCurrency().getRate(), 0.001);
	}
	...
	@Test
	public void testAdd() {
		assertEquals("30000 SEK", SEK100.add(SEK200).toString());
		assertEquals("2000 EUR", EUR10.add(SEK100).toString());
		assertEquals("20000 SEK", SEK100.add(EUR10).toString());
		assertEquals("0 SEK", SEK100.add(SEKn100).toString());
	}

	@Test
	public void testSub() {
		assertEquals("10000 SEK", SEK200.sub(SEK100).toString());
		assertEquals("0 EUR", EUR10.sub(SEK100).toString());
		assertEquals("0 SEK", SEK100.sub(EUR10).toString());
		assertEquals("20000 SEK", SEK100.sub(SEKn100).toString());
	}
	...
	public void testNegate() {
		...
		assertEquals(0, (int)EUR0.negate().getAmount());
	}
