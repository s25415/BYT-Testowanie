...
public class Money implements Comparable {
	...
	public Boolean equals(Money other) {
		return (this.amount * this.currency.getRate() == other.getAmount() * other.currency.getRate());
	}
	...
	public Money add(Money other) {
		int difference = (int) Math.floor(other.universalValue()/this.getCurrency().getRate());
		return new Money(this.amount + difference, this.getCurrency());
	}
	...
	public int compareTo(Object other) {
		...
		if(this.amount * this.currency.getRate() > otherMoney.getAmount() * otherMoney.currency.getRate())
			return 1;
		return -1;
	}
}